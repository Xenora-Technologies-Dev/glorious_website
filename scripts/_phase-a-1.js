...
// ========== company.ts ==========
write('src/content/company.ts', `export const siteUrl = 'https://gloriousascent.com'
...
export const company = {
  ...
  positioning:
    'A global FMCG trading partner connecting quality products, trusted manufacturing partners and international markets.',
  story:
    'Glorious Ascent General Trading L.L.C. is an international import, export and cross-trade FMCG company. From Dubai, we source, manufacture under private label, package and distribute food and non-food products for partners who need a reliable route from origin to shelf.',
  ...
  offices: {
    ...
    uk: {
      ...
      role: 'Sales, support, manufacturing and distribution',
    },
    india: {
      label: 'India',
      operatingName: 'Sunshine General Trading',
      address: '1st Floor, 66 Geetha Mahal, Iddya NH, Surathkal 575014, Mangaluru, India',
      role: 'Indian operations — FMCG, non-food, cosmetics trading',
    },
    ethiopia: {
      label: 'Ethiopia',
      address: 'Address to be confirmed',
      role: 'Regional office — details coming soon',
      placeholder: true,
    },
  },
  factoriesPartners: [
    { name: 'Dachi', note: 'Manufacturing partner' },
    { name: 'Dinesh Flavors', note: 'Manufacturing partner' },
    { name: 'Aachi', note: 'Manufacturing partner' },
    { name: 'Prime Fresh', note: 'Manufacturing partner' },
    { name: 'Siam Food', note: 'Manufacturing partner' },
  ],
  forwarding: [
...
export const whyStatements = [
  ...
  },
  {
    ...
    copy: 'Import, export and cross-trade from Dubai HQ, with offices in the UK, India and Ethiopia, and sourcing and manufacturing origins including Italy, Spain, India and the UAE.',
  },
  {
    index: '03',
    title: 'Product Diversity',
    copy: 'An FMCG range spanning ambient food, frozen & protein, non-food disposables, commodities, confectionery and beverages — with private-label programmes alongside owned brands.',
  },
  {
    index: '04',
